...
import { classesData, eventsData } from "@/lib/data";
    ...
    return (
      ...
      >
        ...
        <td className="hidden md:table-cell">
          {new Intl.DateTimeFormat("en-ZA", { dateStyle: "medium" }).format(item.startTime)}
        </td>
        <td className="hidden lg:table-cell">
          {item.startTime.toLocaleTimeString("en-ZA", { hour: "2-digit", minute: "2-digit" })} -{" "}
          {item.endTime.toLocaleTimeString("en-ZA", { hour: "2-digit", minute: "2-digit" })}
        </td>
        <td>
